...
namespace QLSach.Controllers
{
    public class PublishingsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "PublishingId,Name")] Publishing publishing)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "PublishingId,Name")] Publishing publishing)
        {
            if (ModelState.IsValid)
            {
